...
{
	public string m_editorName = "Use Prince";
	public string m_editorNameLong = "Prin";
...
{	
	...
	public static readonly string SCRIPT_FUNCTION_INTERACT = "PrinceClick";
	public static readonly string SCRIPT_FUNCTION_LOOKAT = "WizardClick";
