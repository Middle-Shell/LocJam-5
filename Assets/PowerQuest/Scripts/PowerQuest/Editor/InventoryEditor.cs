...
public class InventoryComponentEditor : Editor 
{
	...
	public override void OnInspectorGUI()
	{
		...
		if ( PowerQuestEditor.GetActionEnabled(eQuestVerb.Use) && GUILayout.Button("Use Prince") )
		{
		...
		if ( PowerQuestEditor.GetActionEnabled(eQuestVerb.Look) && GUILayout.Button("Use Wizard") )
		{
